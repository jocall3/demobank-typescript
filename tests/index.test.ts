...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new Demobank({ logger: logger, logLevel: 'debug' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Demobank({ logger: logger, logLevel: 'info' });
    ...
    test('debug logs happen with debug env var', async () => {
      ...
      const client = new Demobank({ logger: logger });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['DEMOBANK_LOG'] = 'debug';
      const client = new Demobank({ logger: logger, logLevel: 'off' });
  ...
  test('explicit global fetch', async () => {
    ...
    const client = new Demobank({ baseURL: 'http://localhost:5000/', fetch: defaultFetch });
  });
  ...
  test('normalized method', async () => {
    ...
    const client = new Demobank({ baseURL: 'http://localhost:5000/', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Demobank({ baseURL: 'http://localhost:5000/custom/path/' });
    ...
    test('explicit option', () => {
      const client = new Demobank({ baseURL: 'https://example.com' });
    ...
    test('in request options overridden by client options', () => {
      const client = new Demobank({ baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Demobank({ maxRetries: 4 });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new Demobank({});
    expect(client2.maxRetries).toEqual(2);
  });

  describe('withOptions', () => {
    test('creates a new client with overridden options', async () => {
      const client = new Demobank({ baseURL: 'http://localhost:5000/', maxRetries: 3 });
    ...
    test('respects runtime property changes when creating new client', () => {
      const client = new Demobank({ baseURL: 'http://localhost:5000/', timeout: 1000 });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Demobank({ timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Demobank({ fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Demobank({ fetch: testFetch });
